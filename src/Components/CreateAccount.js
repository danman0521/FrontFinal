    ...
    return (
        ...
        <main className='container mx-auto mt-5 md:mt-20 p-20 md:flex md:justify-center'>
            ...
            <div className='md:w-2/3 lg:-2/5' align="center">
                ...
                <h1 className=" text-center bg-gradient-to-r  from-red-300 via-red-600 to-red-300  bg-clip-text font-display text-5xl tracking-tight text-transparent">
                    Crea Tu Cuenta
                </h1>
                <form
                    onSubmit={onSubmit}
                    className='border-4 border-red-500 my-10 bg-white shadow rounded-lg p-10'
                >
                    <div className=' my-5'>
                    ...
                    <Link
                        ...
                        className=" icon-back  block text-center my-5 text-blue-400 uppercase text-sm"
                    > Regresar</Link>
                </form>
            </div>
        </main>
