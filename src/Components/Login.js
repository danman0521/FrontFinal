    ...
    return (
        <main className='  container mx-auto mt-5 md:mt-20 p-5 md:flex md:justify-center'>
            <div className='md:w-2/3 lg:-2/5 max-w-2xl ' >
                ...
                <h1 className=" bg-gradient-to-r from-red-300 via-red-600 to-red-300 bg-clip-text font-display text-5xl  block text-center tracking-tight text-transparent uppercase">
                    Inicia sesion
                </h1>

                <form
                    className=' border-4   border-red-500   my-1 bg-white shadow rounded-lg p-5'
                    onSubmit={onSubmit}
